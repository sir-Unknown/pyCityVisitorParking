...
PERMIT_LIST_ENDPOINT = "/permit/list"
PERMIT_LIST_FOR_CLIENT_ENDPOINT = "/permit/list_for_client"
PERMIT_OVERVIEW_PRODUCT_LIST_ENDPOINT = "/permit_overview/product_list"
